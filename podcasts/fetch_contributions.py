...
ARTICLES = [
    ...
    dict(slug="experiencing-5x-transformation", title="Experiencing 5x Transformation", platform="Agile Thoughts Magazine", date="2021-06", kind="magazine article", url="https://www.agile-thoughts.com/magazine/jun-2021/"),
    ...
    dict(slug="fighting-against-automation", title="Fighting against Automation isn't doing anyone a favor", platform="Around the World with 80 Software Testers (book)", date="2020-04", kind="book chapter", url="https://leanpub.com/AroundTheWorldWith80SoftwareTesters"),
    ...
    dict(slug="making-teams-awesome", title="Making Teams Awesome", platform="Quality Matters", date="2018", kind="magazine article", url="https://www.quality-matters.org/"),
    ...
    dict(slug="learning-programming-through-osmosis", title="Learning Programming through Osmosis", platform="Voxxed", date="2016-09", kind="article", url="https://www.voxxed.com/blog/2016/09/learning-programming-through-osmosis/"),
...
PODCASTS = [
    ...
    dict(slug="is-manual-testing-dead-ai-blind-spots", title="Is manual testing dead? Why is AI exposing our blind spots", platform="[Dev]olution Podcast", date="2025-12-03", kind="podcast episode", url="https://www.youtube.com/watch?v=c66HADkC63Y"),
    ...
    dict(slug="paradox-of-tight-schedules-lt011", title="Paradox of Tight Schedules, Pull Systems, Ensemble Programming (LT011 Part 1)", platform="Liberated Tester Podcast", date="2023-03-13", kind="podcast episode", url="https://www.youtube.com/watch?v=8KhDYz9q4_c"),
